# nibscbioinformatics/nanoprofiler: Usage
...
```bash
nextflow pull nibscbioinformatics/nanoprofiler
```
...
First, go to the [nibscbioinformatics/nanoprofiler releases page](https://github.com/nibscbioinformatics/nanoprofiler/releases) and find the latest version number - numeric only (eg. `1.3.1`). Then specify this when running the pipeline with `-r` (one hyphen) - eg. `-r 1.3.1`.
...
* `docker`
  ...
  * Pulls software from dockerhub: [`nibscbioinformatics/nanoprofiler`](http://hub.docker.com/r/nibscbioinformatics/nanoprofiler/)
* `singularity`
